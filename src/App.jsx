...
const App=()=> {
 const pageSize=5;
const apiKey= "9863d26f387443a6a82c2126cc739589"
    ...
    return (
      ...
      />
        <Routes>
         ...
         <Route path='/' element={<News setProgress={setProgress}  apiKey={apiKey} key='general1' pageSize={pageSize} country='us' category='general' />}></Route>
